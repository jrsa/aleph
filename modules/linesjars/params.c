...
extern void fill_param_desc(ParamDesc* desc) {
  ...
  desc[eParam_feedback].max = PARAM_AMP_MAX;
  desc[eParam_feedback].radix = 16;

  strcpy(desc[eParam_dry].label, "dry");
  desc[eParam_dry].type = eParamTypeAmp;
  desc[eParam_dry].min = 0x00000000;
  desc[eParam_dry].max = PARAM_AMP_MAX;
  desc[eParam_dry].radix = 16;

  strcpy(desc[eParam_wet].label, "wet");
  desc[eParam_wet].type = eParamTypeAmp;
  desc[eParam_wet].min = 0x00000000;
  desc[eParam_wet].max = PARAM_AMP_MAX;
  desc[eParam_wet].radix = 16;
}
